    ...
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?= $c == 'home' ? 'active' : '' ?>" href="index.html">Trang chủ</a>
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a
                                    href="tel:0932.538.468">0888.308.026</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a
                                    href="mailto:nguyenhuulocla2006@gmail.com">son0128525@gmail.com</a></span>
                        </p>
                    </div>
    ...
    <nav class="navbar navbar-default desktop-menu">
        <div class="container">
            <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                ...
                <li class="<?= $a == 'informationIntroduction' ? 'active' : '' ?>"><a
                        href="?c=information&a=informationIntroduction">Về chúng tôi</a></li>
